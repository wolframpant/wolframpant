...
Interest.create!(
  ...
  description: "When I was three years old, I 'twirled' a baton in a parade. In that moment I knew that the world of performance would be something special in my life. Dancing lessons, piano lessons, gymnastics and ice skating followed. I played the lead in all my elementary school's plays, as I was known to memorize my lines easily; by junior high school, when auditions became crucial, I stopped easily getting lead roles. I was disappointed, but not for long--I decided that being involved in the creative process was more important than being onstage. So, I invented the concept of stage crew at my camp and at my high school. I built and painted sets, found and created props, and came up with any excuse I could to be present and useful at rehearsals and performances. I also joined my high school's Concert Choir, and--don't ask me how--taught myself to sing on key! By college, I was a stage manager and a director. Years later, I spent a year performing with a puppet troupe, and even later I followed up on my fascination with the performing arts by attaining a Master's Degree and  pursuing a PhD in Theatre.")
